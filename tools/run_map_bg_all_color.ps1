<#
.SYNOPSIS
Run make_map_bg.py --pipeline color for every non-mod region under masks/.
...
map_bg_<Scene>_color.png under out\maps_color (or -OutDir).
...
.EXAMPLE
./tools/run_map_bg_all_color.ps1 -Jobs 1

.EXAMPLE
./tools/run_map_bg_all_color.ps1 -Size 8192 -Jobs 2
...
Write-Host "run_map_bg_all_color: $($pending.Count) queued, Jobs=$Jobs" -ForegroundColor Cyan
